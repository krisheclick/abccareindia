        ...
        <Stack as="section" className={`donation_section ${Styles.donation_section}`}>
            <Container>
                <Row className='align-items-stretch g-4'>
                    <Col xl={4}>
                        <div className={`mb-2 wow animate__lightSpeedInLeft smallsubhead ${Styles.smallsubhead}`}>{commonData?.site_donation_heading_title}</div>
                    ...
                    <Col lg={6} xl={4}>
                        <div className={`wow animate__fadeInUp h-100 info_box ${Styles.info_box} ${Styles.volunteerBox}`} data-wow-delay=".25s">
                    ...
                    <Col lg={6} xl={4}>
                        <div className={`wow animate__fadeInUp h-100 info_box ${Styles.info_box} ${Styles.donateBox}`} data-wow-delay=".5s">
